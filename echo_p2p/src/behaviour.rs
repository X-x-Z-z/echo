...
//! Combined libp2p NetworkBehaviour for the Lostecho full node.
//!
//! ## Peer discovery stack
//!
//! Lostecho uses three complementary mechanisms, mirroring the approach taken
...
const GOSSIPSUB_MESSAGE_ID_DOMAIN: &[u8] = b"ECHO_P2P_GOSSIPSUB_MESSAGE_ID";
...
impl NodeBehaviour {
    ...
    pub fn new(
        ...
        let identify = identify::Behaviour::new(
            identify::Config::new("/echo/1.0.0".into(), key.public())
