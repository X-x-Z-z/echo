...
pub fn capacity_iv_flat(tag: DomainTag) -> [u128; 2] {
    ...
    [
        echo_core::hardware::tower_to_flat_u128(high.0),
        echo_core::hardware::tower_to_flat_u128(low.0),
    ]
}
...
/// Wallet-capsule FRI transcript (`echo_fri::Channel`) and its replays.
...
/// Exact UTXO state slot leaf: `LOSTECHO/EXACT-STATE-SLOT/256/v1`.
pub const TAG_EXSTSLT: DomainTag = DomainTag::new(b"EXSTSLT_");
/// Exact UTXO state binary Merkle node: `LOSTECHO/EXACT-STATE-NODE/256/v1`.
