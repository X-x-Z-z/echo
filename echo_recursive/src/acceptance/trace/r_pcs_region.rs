...
use echo_ivc_core::proof::pcs_params_statement_bytes;
...
use echo_ivc_core::field_circuit::RecordedChannel as FsRecordedChannel;
...
const LINK_R_PCS_LEAF_SIDECAR_PURPOSE_DOMAIN: &[u8] = b"ECHO/REGION-SIDECAR/LINK-R-PCS-LEAF-A/V1";
const LINK_R_PCS_PATH_SIDECAR_PURPOSE_DOMAIN: &[u8] = b"ECHO/REGION-SIDECAR/LINK-R-PCS-PATH-B/V1";
...
const LINK_RECORDINGS_REC_PURPOSE_DOMAIN: &[u8] = b"ECHO/REGION-SIDECAR/HISTORY-STEP-RECORDINGS/V1";
...
impl HistoryStepParentGeometry {
    ...
    pub(crate) fn new(
        ...
        let tier_count = echo_chain::consensus::params::BLOCK_PAGE_CLASS_TIERS.len();
...
fn native_leaf_digest(lanes: &[F128]) -> [F128; 2] {
    ...
    flat_digest_lanes(&echo_ivc_core::merkle::hash_leaf(&bytes))
}
...
mod tests {
    ...
    use echo_ivc_core::field::F256;
    use echo_ivc_core::field_circuit::{ExtExpr, FsChannelOps};
    use echo_ivc_core::pcs::LOG_PACKING;
