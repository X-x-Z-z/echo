...
//!
//! Trace twins of `echo_gkr::accepted_claim_killshot`:
...
use echo_gkr::accepted_claim_killshot::{
...
use echo_gkr::block_spine::num_vars_for;
use echo_poseidon2b::native::domain::{capacity_iv, TAG_ACCBLK};
...
mod tests {
    ...
    use echo_poseidon2b::native::compression::Poseidon2bSponge;
    ...
    fn build_slot(
        ...
        echo_ivc_core::field_r1cs::FieldR1cs,
        Vec<echo_ivc_core::field::F128>,
        bool,
    ) {
    ...
    ///
    /// Full sweep by default; `ECHO_TRACE_MUTATE_STRIDE=k` samples every
    ...
    /// `ECHO_TRACE_CROSS_CASES=n` to override.
    #[test]
