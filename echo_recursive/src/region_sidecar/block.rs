...
pub(crate) fn selected_zk_block_geometry_for_auth_tiles(
    ...
    echo_chain::consensus::params::BLOCK_PAGE_CLASS_TIERS
        .into_iter()
...
const BLOCK_REGION_SELECTED_ZK_VK_DIGEST_DOMAIN: &[u8] = b"ECHO/REGION-SIDECAR/BLOCK-ZK-AUTH-VK/V6";
const BLOCK_SELECTED_ZK_POST_COMMIT_CLASS_DIGEST_DOMAIN: &[u8] =
    b"ECHO/REGION-SIDECAR/BLOCK-ZK-AUTH-POST-COMMIT-CLASS/V6";
...
impl BlockRegionSidecarVk {
    ...
    pub(crate) fn validate_selected_zk_roles(&self) -> Result<(), RegionSidecarError> {
        ...
        let geometry = echo_chain::consensus::params::BLOCK_PAGE_CLASS_TIERS
            .into_iter()
            .filter_map(selected_zk_block_geometry)
...
fn selected_duplex_vk_matches(
    vk: &DuplexRegionVk,
    layout: &echo_ivc_core::deep_chain::schedule::DuplexLayout,
    purpose: [u8; 32],
    w_log: usize,
    tile_log: usize,
) -> bool {
...
pub(crate) fn shape_only_c1_block_region_walk_deferred_proof(
    ...
    use echo_ivc_core::deep_chain::relations::c1::{C1ColumnRelationProof, C1ShiftDischargeProof};
    ...
    let relation = |rounds: usize, values: usize| C1ColumnRelationProof {
        rounds: vec![[F256::ZERO; echo_ivc_core::deep_chain::relations::RELATION_DEGREE]; rounds],
