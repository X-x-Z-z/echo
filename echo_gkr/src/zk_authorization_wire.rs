...
use echo_fri_binius::zk_phase_a::ZkPhaseAProof;
...
mod tests {
    ...
    use echo_fri_binius::interleaved_commit::{MerkleCap, SourceBatchedMerkleProof, SourceHash};
    use echo_fri_binius::zk_capsule_algebra::{TAIL_SYMBOLS, UPPER_SYMBOLS};
    use echo_fri_binius::zk_capsule_pcs::{
        ZkCapsulePcsMidCommitment, ZkCapsulePcsOpening, ZkCapsulePcsSourceCommitment,
        ZkCapsulePcsTailReveal,
    };
