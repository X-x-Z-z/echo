...
//! `AsyncMempool` in `echo_mempool` wraps this in async admission/eviction tasks and connects it to the
//! P2P layer and the block template builder.
//!
//! # Design
//!
//! Admission and authorization run in `echo_mempool`; this module only owns
...
use echo_poseidon2b::primitives::{Address, Digest, TxBodyHash};
use echo_tx::{
...
impl MempoolEntry {
    ...
    pub fn new(pages: Vec<TxPage>, current_height: u64) -> Result<Self, echo_tx::PagedSpendError> {
