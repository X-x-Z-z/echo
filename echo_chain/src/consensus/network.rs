...
//! Network configuration for Lostecho mainnet.
//!
...
impl NetworkConfig {
    pub fn mainnet() -> Self {
        Self {
            ...
            magic: [0x4E, 0x4F, 0x49, 0x44], // "ECHO"
            ...
            p2p_protocol_id: "/echo/mainnet/860e70453390bf81/1",
            topic_blocks: "/echo/mainnet/860e70453390bf81/blocks/1",
            topic_txs: "/echo/mainnet/860e70453390bf81/txs/1",
...
mod tests {
    ...
    fn mainnet_protocol_id() {
        ...
        assert_eq!(mainnet.p2p_protocol_id, "/echo/mainnet/860e70453390bf81/1");
        assert_eq!(
            mainnet.topic_blocks,
            "/echo/mainnet/860e70453390bf81/blocks/1"
        );
        assert_eq!(mainnet.topic_txs, "/echo/mainnet/860e70453390bf81/txs/1");
    }
