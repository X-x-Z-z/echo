...
use echo_poseidon2b::primitives::Digest;
use echo_tx::TxBody;
...
pub struct ChainState {
    ...
    /// Exact sum of every live UTXO amount in μECHO.
    ///
...
impl ChainState {
    ...
    pub fn durable_metadata_clone(&self) -> Option<Self> {
        Some(Self {
            ...
            circulating_supply_microecho: self.circulating_supply_microecho,
    ...
    pub fn from_loaded_parts(
        ...
        let circulating_supply_microecho = Self::loaded_circulating_supply(&state)?;
    ...
    pub(crate) fn from_evicted_parts(
        ...
        active_slot_count: u64,
        alloc_counter: u64,
        circulating_supply_microecho: u128,
    ...
    pub fn from_sparse_utxos(
        ...
        state.circulating_supply_microecho = slots
            .iter()
    ...
    pub(crate) fn supply_after_slot_updates(
        ...
        let mut supply = self.circulating_supply_microecho;
    ...
    pub fn apply_verified_exact_transition(
        ...
        let circulating_supply_microecho = self
        ...
        self.circulating_supply_microecho = circulating_supply_microecho;
        Ok(applied_root)
    }
}
...
pub(crate) fn apply_tx_checked_deferred_root(
    ...
    let circulating_supply_microecho = state
    ...
    state.circulating_supply_microecho = circulating_supply_microecho;
    Ok(())
}
...
mod tests {
    ...
    fn funded() -> ChainState {
        ...
        state.circulating_supply_microecho = 11;
        state
    }
    ...
    fn explicit_input_owner_matches_state_and_output_gets_new_incarnation() {
        ...
        assert_eq!(state.circulating_supply_microecho, 10);
    }
    ...
    fn wrong_owner_and_occupied_output_fail_atomically() {
        ...
        let supply = state.circulating_supply_microecho;
        assert_eq!(
            apply_tx(&mut state, &body(Address([9u8; 32]), 1, 2)),
            Err(ApplyError::UnknownOrSpentInput)
        );
        assert_eq!(state.state_root(), root);
        assert_eq!(state.circulating_supply_microecho, supply);
    ...
    fn coinbase_mint_is_height_tagged_and_aba_binds_exact_creation_id() {
        ...
        assert_eq!(state.active_slot_count, 1);
        assert_eq!(state.circulating_supply_microecho, 50);
        ...
        assert_eq!(state.circulating_supply_microecho, 49);
    }
    ...
    fn development_payout_uses_the_normal_allocator_namespace() {
        ...
        let payout = TxBody {
            ...
            outputs: [
                ...
                TxOutput {
                    slot_index: 6,
                    amount: 10,
                    owner: crate::consensus::development_allocation::LOSTECHO_LAB_ADDRESS,
                },
            ],
        ...
        assert_eq!(state.circulating_supply_microecho, 65);
    }
    ...
    fn verified_exact_transition_updates_the_derived_supply_atomically() {
        ...
        assert_eq!(state.circulating_supply_microecho, 8);
