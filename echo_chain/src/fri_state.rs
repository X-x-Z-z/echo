...
use echo_tx::{pack_amount_creation_id, unpack_amount_creation_id};
...
use echo_fri_binius::interleaved_commit_cap;
...
/// (see `echo_tx::public::PublicInputs::log_slots` and `MAX_LOG_SLOTS`),
...
const MIN_COMMIT_LOG: usize = echo_fri_binius::MERKLE_CAP_DEPTH;
...
pub fn compute_segment_root(
    ...
    let ntt = echo_core::AdditiveNTT::<Block128>::new(commit_log + echo_fri::code::LOG_RATE);
...
pub fn cap_to_seg_root(cap: &echo_fri_binius::MerkleCap) -> StateRoot {
...
fn state_cap_odd_pad(level: u64, layer_len: usize) -> [u8; 32] {
    ...
    pad[16..].copy_from_slice(b"ECHO_STATE_PAD_v");
    pad
}
...
pub fn cap_to_seg_root_with_depth(cap: &echo_fri_binius::MerkleCap, eff_log: usize) -> StateRoot {
