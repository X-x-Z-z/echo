...
const SNAPSHOT_MANIFEST_DOMAIN: &[u8] = b"ECHO_DISK_SNAPSHOT_GENERATION_MANIFEST_V6";
const SNAPSHOT_PAYLOAD_DOMAIN: &[u8] = b"ECHO_DISK_SNAPSHOT_GENERATION_PAYLOAD_V1";
...
mod tests {
    ...
    fn unchanged_canonical_state_exports_incrementally_end_to_end() {
        ...
        changed_state
            ...
            .unwrap();
        changed_state.circulating_supply_microecho = u128::from(changed_slot.amount());
        ...
        store
            .commit_block(
                ...
                changed_state.circulating_supply_microecho,
                &grandchild_meta,
                false,
            )
            .unwrap();
