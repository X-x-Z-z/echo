...
use echo_ivc_core::pcs::Commitment;
use echo_ivc_core::proof::R1csProof;

pub const MAGIC: [u8; 5] = *b"ECHOI";
...
impl std::fmt::Display for DeserializeError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::BadMagic => write!(f, "bad magic: not a ECHOI IVC proof bundle"),
...
mod tests {
    ...
    fn rejects_bad_magic() {
        ...
        bytes.extend_from_slice(b"ECHOH");
        assert!(matches!(
