...
#[rpc(server, namespace = "lostecho")]
pub trait LostechoApi {
    // =========================================================================
    // Chain
    // =========================================================================
    ...
    /// Estimated minimum fee in μECHO for a transaction with `n_outputs` outputs.
    ...
    // =========================================================================
    // Wallet RPC methods (echo_walletXxx namespace preserved via method name)
    // =========================================================================
    ...
    /// `fee_microecho = 0` computes the automatic fee.
    ...
    /// `amount_microecho`: amount in μECHO.
    /// `fee_microecho`: exact fee (0 = automatic fee).
