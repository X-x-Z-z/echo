...
use echo_ivc_core::deep_chain::c1::C1LaneClaimGroup;
use echo_ivc_core::deep_chain::capsule_leaf::{
...
use echo_ivc_core::deep_chain::relations::{claimed_refs, ColRef, FixedPattern};
use echo_ivc_core::deep_chain::schedule::{
    carry_selection_terms, flat_of_tower_u128, DuplexLayout, LaneSource,
};
use echo_ivc_core::deep_chain::source_tree::SourceTreeRefs;
...
use echo_ivc_core::pcs::{C1QuirkyDirectClaim, QuirkyDirectClaim};
...
const WALK_A_LAYOUT_DIGEST_DOMAIN: &[u8] = b"ECHO/REGION-SIDECAR/WALK-A-LAYOUT/V1";
const WALK_A_VK_DIGEST_DOMAIN: &[u8] = b"ECHO/REGION-SIDECAR/WALK-A-VK/V1";
...
pub(crate) fn verify_c1_walk_a_region_walk_deferred_prefix<'a, Ch: Challenger>(
    ...
    let timing = std::env::var_os("ECHOH_C1_VERIFY_TIMING").is_some();
...
pub(in crate::region_sidecar) mod tests {
    ...
    use echo_ivc_core::deep_chain::leaf_hash::build_sponge_leaf_columns;
    use echo_ivc_core::deep_chain::relations::{
        prove_column_relation, verify_column_relation, RelationColumns,
    };
    use echo_ivc_core::deep_chain::schedule::carry_selection_terms;
    use echo_ivc_core::deep_chain::source_tree::run_perm;
    use echo_ivc_core::deep_chain::spine::{build_spine_instance_columns, SpineInstanceFlat};
    use echo_ivc_core::field_circuit::{FieldR1csBuilder, FsChannelTrace, LinExpr};
    use echo_ivc_core::field_r1cs::FieldR1cs;
    use echo_ivc_core::lincheck::build_eq_table;
    use echo_ivc_core::pcs::{self, Commitment, PcsParams};
    use echo_ivc_core::proof::{FieldR1csProof, FieldShape};
