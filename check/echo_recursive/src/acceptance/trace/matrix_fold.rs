//! Trace twin of `echo_ivc_core::matrix_claim::verify_matrix_claim_fold`
...
use echo_ivc_core::matrix_claim::c1::{C1MatrixAccClaim, C1MatrixFoldProof};
use echo_ivc_core::matrix_claim::MatrixFoldProof;
...
impl MatrixAccClaimTrace {
    pub fn alloc(
        ...
        native: &echo_ivc_core::matrix_claim::MatrixAccClaim,
    ) -> Self {
        Self {
            point: native
                .point
