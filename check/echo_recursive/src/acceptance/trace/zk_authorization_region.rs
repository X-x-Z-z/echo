...
#[cfg(test)]
use echo_fri::hasher::CryptographicHasher;
use echo_fri_binius::capsule::{
    capsule_leaf_hash_mixed, capsule_leaf_hash_wide, CapsuleNodeHasher,
};
use echo_fri_binius::interleaved_commit::{
...
use echo_poseidon2b::native::domain::{capacity_iv, capacity_iv_flat, TAG_CAPSNODE, TAG_KSCH256};
...
fn place_ff_dense(
    ...
    columns: &echo_ivc_core::deep_chain::ff_merkle::FfMerklePathColumns,
    n_paths: usize,
    depth: usize,
