...
pub(crate) fn row_ledger_mark(
    builder: &echo_ivc_core::field_circuit::FieldR1csBuilder,
    last: &mut usize,
    label: &str,
) {
    if std::env::var_os("ECHO_ROW_LEDGER").is_some() {
...
pub(crate) fn expand_empty_field_tail(
    mut r1cs: echo_ivc_core::field_r1cs::FieldR1cs,
    mut witness: Vec<echo_ivc_core::field::F128>,
    ...
    let expand = |matrix: &mut echo_ivc_core::field_r1cs::SparseFieldMatrix| {
