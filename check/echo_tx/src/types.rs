...
//!
//! Lostecho has one fixed transaction form: eight possible spends and two
...
//! fields and enter proving only through `echo_gkr::OwnerAuthWitness`.

use echo_core::Block128;
use echo_poseidon2b::primitives::{Address, Commitment, Digest, TxBodyHash};
...
impl TxInput {
    ...
    pub fn commitment(&self, owner: &Address) -> Commitment {
        echo_poseidon2b::primitives::hash_utxo_leaf(
