...
use echo_poseidon2b::native::domain::{capacity_iv, TAG_BLOCKHDR, TAG_POWHDR};
use echo_poseidon2b::native::permutation::{Poseidon2bPermutation, MDS_FULL, N_ROUNDS, STATE_SIZE};
...
// Public: the in-circuit trace transliteration (`echo_recursive::acceptance::trace`)
