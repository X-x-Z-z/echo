...
///
/// ```compile_fail
/// use echo_fri_binius::ZkCapsulePcsSourceProverState;
///
...
/// use echo_fri_binius::{zk_capsule_pcs_bind_phase_a, ZkCapsulePcsSourceProverState};
///
...
/// ```compile_fail
/// use echo_core::Block128;
/// use echo_fri_binius::{zk_capsule_pcs_commit_mid, ZkCapsulePcsSourceProverState};
///
