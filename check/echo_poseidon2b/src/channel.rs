...
//! [`echo_core::transcript::FiatShamir`].
//!
//! This is the *production* transcript for protocols in `echo_core` that
...
//! test vectors downstream (notably in `echo_fri` prover/verifier and
