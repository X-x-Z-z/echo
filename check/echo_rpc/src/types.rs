...
//! JSON response types for the Lostecho RPC API.
...
pub struct ChainInfo {
    ...
    pub circulating_supply_microecho: String,
}
...
pub struct BlockTemplateResponse {
    ...
    /// Coinbase output value in μECHO.
    pub coinbase_value_microecho: u64,
    /// Sum of user fees claimable by the miner after burned state-growth fees.
    pub claimable_fees_microecho: u64,
}
...
pub struct WalletStatus {
    ...
    /// Confirmed balance of the ACTIVE address in μECHO.
    pub balance_microecho: u64,
    /// Active-address balance in ECHO (6 decimal places).
    pub balance_echo: f64,
...
pub struct WalletBalance {
    ...
    #[serde(default)]
    pub pending_incoming_microecho: u64,
    /// Spendable = active balance - pending_outbound.
    pub spendable_microecho: u64,
    pub spendable_echo: f64,
}
...
pub struct WalletSendPlan {
    pub amount_microecho: u64,
    pub fee_microecho: u64,
    pub total_spend_microecho: u64,
    pub input_count: usize,
    pub output_count: usize,
    pub change_microecho: u64,
...
pub struct MiningInfo {
    ...
    pub difficulty_target: String,
    /// Block reward for the next block in μECHO.
    pub block_reward_microecho: u64,
    /// Block reward in ECHO.
    pub block_reward_echo: f64,
...
/// Convert μECHO to ECHO with 6 decimal places.
#[inline]
pub fn microecho_to_echo(microecho: u64) -> f64 {
    microecho as f64 / 1_000_000.0
}
...
pub struct MempoolInfo {
    ...
    pub size: usize,
    /// Current dynamic fee floor in μECHO.
    pub fee_floor: u64,
