...
//! coordinate-wise basis bridge to [`echo_core::Block256`] a field
...
fn tower_f128(value: F128) -> Block128 {
    ...
    Block128(echo_core::hardware::flat_to_tower_u128(flat))
}
...
unsafe fn mul_f256_avx2(left: F256, right: F256) -> F256 {
    use echo_core::packed::{PackedBlock128, clmul_avx2::packed_mul_flat_avx2};
