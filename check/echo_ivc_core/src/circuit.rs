...
//!
//! The field laws come from `echo_core`; this module only materializes those
//! laws as Boolean R1CS constraints.

use echo_core::{Block8, Block16, Block32, Block64, Block128, TowerField};
...
mod tests {
    ...
    #[test]
    fn block128_mul_gadget_matches_echo_core() {
