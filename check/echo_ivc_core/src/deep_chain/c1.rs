...
fn square_f256_pair(left: F256, right: F256) -> [F256; 2] {
    let square_base = |value: F128| {
        ...
        let square = echo_core::hardware::square_flat_u128(flat);
...
pub fn prove_ragged_deep_chain_walk<C: Challenger>(
    ...
    let timing = std::env::var_os("ECHOH_C1_DEEP_CHAIN_TIMING").is_some();
    ...
    if timing {
        eprintln!(
            "ECHOH C1 deep-chain-ragged widths={w_logs:?} state_init_ms={} setup_ms={} state_fetch_ms={} sumcheck_ms={} first_contribution_ms={} wide_contribution_ms={} fold_ms={} finish_ms={} total_ms={}",
...
mod tests {
    ...
    fn genuine_c1_joint_b25_sidecar_micro_profile() {
        ...
        eprintln!(
            "ECHOH genuine-C1 joint-B25-sidecar elapsed_ms={} layers={} terminals={}",
