...
//!
//! Format: `echo_plain_key_1` (16 bytes magic) + secret (32 bytes) = 48 bytes.
//!
//! Security model: the file is stored at `~/.lostecho/data/wallet.key` with
...
const PLAIN_MAGIC: &[u8; 16] = b"echo_plain_key_1";
...
impl MasterSecret {
    ...
    pub(super) fn derive_spend_secret(&self, index: u32) -> SpendSecret {
        ...
        sponge.absorb(Block128::from(0x6E6F69642D64657269_u128)); // "echo-deri"
    ...
    pub(super) fn derive_address(&self, index: u32) -> Address {
        ...
        echo_poseidon2b::primitives::derive_address(&secret)
    }
}
