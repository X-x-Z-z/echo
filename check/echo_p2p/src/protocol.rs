...
//! Wire message types for the Lostecho P2P protocol.
//!
...
use echo_poseidon2b::native::poseidon2b_hash_bytes;
...
const _: () =
    assert!(SNAPSHOT_BOUNDARY_INTERVAL <= echo_chain::consensus::params::CONSENSUS_FINALITY_DEPTH);
...
pub const MAX_SNAPSHOT_MANIFEST_PAGES: usize =
    echo_chain::consensus::wire_limits::MAX_SNAPSHOT_MANIFEST_SEGMENTS
        .div_ceil(SNAPSHOT_MANIFEST_DESCRIPTORS_PER_PAGE);
const SNAPSHOT_MANIFEST_PAGE_MAGIC: [u8; 4] = *b"NMP1";
const SNAPSHOT_MANIFEST_PAGE_DIGEST_DOMAIN: &[u8] = b"LOSTECHO/P2P/SNAPSHOT-MANIFEST-PAGE/V1";
...
const SNAPSHOT_MANIFEST_DIGEST_DOMAIN: &[u8] = b"LOSTECHO/P2P/SNAPSHOT-MANIFEST/V2";
...
impl GetStateManifestHeader {
    ...
    pub fn has_canonical_page_shape(&self) -> bool {
        ...
        if segment_count > echo_chain::consensus::wire_limits::MAX_SNAPSHOT_MANIFEST_SEGMENTS {
            return false;
        }
...
pub struct GetStateSegmentResponse {
    ...
    pub status: DataResponseStatus,
    pub eff_log: u8,
    /// Column data encoded by `echo_chain::storage::serial::encode_segment`.
...
impl Topics {
    pub const BLOCKS: &'static str = "/echo/devnet/blocks/1";
    pub const TXS: &'static str = "/echo/devnet/txs/1";
}
...
impl NetworkTopics {
    pub fn for_network_cfg(cfg: &echo_chain::consensus::NetworkConfig) -> Self {
        Self {
