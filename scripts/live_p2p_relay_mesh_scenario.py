...
BASE = Path(
    os.environ.get(
        "ECHO_LIVE_RELAY_MESH_DIR",
        str(RUN_PARENT / f"relay-mesh-clean-{STAMP}"),
    )
)
CLIENT_COUNT = int(os.environ.get("ECHO_LIVE_RELAY_MESH_CLIENTS", "16"))
SETTLE_SECONDS = int(os.environ.get("ECHO_LIVE_RELAY_MESH_SETTLE_SECONDS", "45"))
TARGET_HEIGHT = int(os.environ.get("ECHO_LIVE_RELAY_MESH_TARGET_HEIGHT", "2"))
