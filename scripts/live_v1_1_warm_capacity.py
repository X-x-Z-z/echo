...
def scenario(args):
    ...
    old_gate = os.environ.get("ECHO_ISOLATED_MINER_START_GATE")
    os.environ["ECHO_ISOLATED_MINER_START_GATE"] = str(gate)
    try:
        ...
        if old_gate is None:
            ...
            os.environ["ECHO_ISOLATED_MINER_START_GATE"] = old_gate
