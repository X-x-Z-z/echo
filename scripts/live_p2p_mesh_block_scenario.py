...
BASE = Path(
    os.environ.get(
        "ECHO_LIVE_P2P_MESH_BLOCK_DIR",
        str(RUN_PARENT / f"p2p-mesh-block-clean-{STAMP}"),
    )
)
BASE_PORT = int(os.environ.get("ECHO_LIVE_P2P_MESH_BLOCK_BASE_PORT", "21400"))
PEER_COUNT = int(os.environ.get("ECHO_LIVE_P2P_MESH_BLOCK_PEERS", "16"))
TARGET_HEIGHT = int(os.environ.get("ECHO_LIVE_P2P_MESH_BLOCK_HEIGHT", "2"))
