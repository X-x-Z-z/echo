...
use echo_recursive::{canonical_history_step_shape, CanonicalHistoryStepClassId};

const PACK_DIRECTORY_ENV: &str = "ECHO_HISTORY_STEP_PACK_DIR";
const SAMPLE_COUNT_ENV: &str = "ECHO_MATRIX_FOLD_SAMPLES";
const NODE_CPU_POOL_ENV: &str = "ECHO_HISTORY_STEP_NODE_CPU_POOL";
...
const TRANSCRIPT_DOMAIN: &[u8] = b"ECHO/BENCH/MATRIX-CLAIM-C1/V1";
...
fn load_b25_matrix() -> Result<CompactFieldR1cs, String> {
    ...
    let runtime = echo_miner::decode_history_step_runtime_metadata_pinned(&metadata, digest)
