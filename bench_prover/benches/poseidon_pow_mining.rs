...
use echo_chain::consensus::pow::{pow_header_fields, PowNonceBatchHasher};
...
fn main() {
    let seq_attempts = env_u64("ECHO_POSEIDON_POW_SEQ", 20_000);
    let par_attempts = env_u64("ECHO_POSEIDON_POW_PAR", 200_000);
    ...
    println!();
    println!("  =====================================================================");
    println!("  LOSTECHO Poseidon2b PoW Mining Benchmark");
    println!("  =====================================================================");
    println!("  Measures production H_POSEIDON_POW(header fields with patched nonce).");
    println!("  Override: ECHO_POSEIDON_POW_SEQ=20000 ECHO_POSEIDON_POW_PAR=200000");
    println!();
