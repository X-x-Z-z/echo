...
//!
//! Usage: `echo_matrix_stats <artifact.field-r1cs.zst>...`

use std::time::Instant;

use echo_ivc_prover::field_r1cs::{FieldR1cs, SparseFieldMatrix};
use echo_ivc_prover::proof::FieldShape;
...
fn main() {
    for path in std::env::args().skip(1) {
        ...
        assert_eq!(&raw[..8], b"ECHOR1CS", "artifact magic");
